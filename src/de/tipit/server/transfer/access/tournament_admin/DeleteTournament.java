...
public class DeleteTournament implements TournamentAdminTask {
    ...
    public InvocationResult execute(TournamentAdmin delegate) {
        try {
            return new InvocationResult(new Result(delegate.deleteTournament(context, sessionId, tournId)));
