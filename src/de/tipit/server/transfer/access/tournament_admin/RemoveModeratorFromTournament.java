...
public class RemoveModeratorFromTournament implements TournamentAdminTask {
    ...
    public InvocationResult execute(TournamentAdmin delegate) {
        try {
            return new InvocationResult(new Result(delegate.removeModeratorFromTournament(context, sessionId, tournId, modId)));
