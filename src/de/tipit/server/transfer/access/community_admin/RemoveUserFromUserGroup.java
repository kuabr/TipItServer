...
public class RemoveUserFromUserGroup implements CommunityAdminTask {
    ...
    public InvocationResult execute(CommunityAdmin delegate) {
        try {
            return new InvocationResult(new Result(delegate.removeUserFromUserGroup(context, sessionId, userGroupId, userId)));
