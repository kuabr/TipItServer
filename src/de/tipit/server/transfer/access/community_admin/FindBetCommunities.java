...
public class FindBetCommunities implements CommunityAdminTask {
    ...
    @Element(required = true)
    private BetCommunitySearchDataTO betCommunitySearchData;

    @Override
    public InvocationResult execute(CommunityAdmin delegate) {
        try {
            return new InvocationResult(new Result(delegate.findBetCommunities(context, sessionId, betCommunitySearchData)));
    ...
    public BetCommunitySearchDataTO getBetCommunitySearchData() {
        return betCommunitySearchData;
    }

    public void setBetCommunitySearchData(BetCommunitySearchDataTO betCommunitySearchData) {
        this.betCommunitySearchData = betCommunitySearchData;
    }
}
