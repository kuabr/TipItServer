...
public class AddTournamentToBetCommunity implements CommunityAdminTask {
    ...
    public InvocationResult execute(CommunityAdmin delegate) {
        try {
            return new InvocationResult(new Result(delegate.addTournamentToBetCommunity(context, sessionId, betCommunityId, tournId)));
