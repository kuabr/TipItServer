...
public class AddModeratorToBetCommunity implements CommunityAdminTask {
    ...
    public InvocationResult execute(CommunityAdmin delegate) {
        try {
            return new InvocationResult(new Result(delegate.addModeratorToBetCommunity(context, sessionId, betCommunityId, modId)));
