...
public class AddUserGroupToBetCommunity implements CommunityAdminTask {
    ...
    public InvocationResult execute(CommunityAdmin delegate) {
        try {
            return new InvocationResult(new Result(delegate.addUserGroupToBetCommunity(context, sessionId, betCommunityId, userGroupId)));
