...
public class DeleteUserGroup implements CommunityAdminTask {
    ...
    public InvocationResult execute(CommunityAdmin delegate) {
        try {
            return new InvocationResult(new Result(delegate.deleteUserGroup(context, sessionId, userGroupId)));
