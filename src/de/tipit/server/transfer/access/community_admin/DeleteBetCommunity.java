...
public class DeleteBetCommunity implements CommunityAdminTask {
    ...
    public InvocationResult execute(CommunityAdmin delegate) {
        try {
            return new InvocationResult(new Result(delegate.deleteBetCommunity(context, sessionId, betCommunityId)));
