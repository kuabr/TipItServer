...
public class GetBetCommunitiesForUserGroup implements CommunityAdminTask {
    ...
    public InvocationResult execute(CommunityAdmin delegate) {
        try {
            return new InvocationResult(new Result(delegate.getBetCommunitiesForUserGroup(context, sessionId, userGroupId)));
