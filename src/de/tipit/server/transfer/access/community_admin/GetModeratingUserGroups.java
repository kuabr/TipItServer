...
public class GetModeratingUserGroups implements CommunityAdminTask {
    ...
    public InvocationResult execute(CommunityAdmin delegate) {
        try {
            return new InvocationResult(new Result(delegate.getModeratingUserGroups(context, sessionId)));
