...
public class GetTournamentRankingByUser implements AnalysisTask {
    ...
    public InvocationResult execute(Analysis delegate) {
        try {
            return new InvocationResult(new Result(delegate.getTournamentRankingByUser(context, sessionId, betCommunityId, tournId, onlyUsersWithBet)));
