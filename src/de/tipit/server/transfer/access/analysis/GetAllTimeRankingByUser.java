...
public class GetAllTimeRankingByUser implements AnalysisTask {
    ...
    public InvocationResult execute(Analysis delegate) {
        try {
            return new InvocationResult(new Result(delegate.getAllTimeRankingByUser(context, sessionId, betCommunityId, onlyUsersWithBet)));
