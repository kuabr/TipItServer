...
public class GetTournamentRankingByUserGroup implements AnalysisTask {
    ...
    public InvocationResult execute(Analysis delegate) {
        try {
            return new InvocationResult(new Result(delegate.getTournamentRankingByUserGroup(context, sessionId, betCommunityId, tournId)));
