...
public class GetTournamentRoundRankingByUserGroup implements AnalysisTask {
    ...
    public InvocationResult execute(Analysis delegate) {
        try {
            return new InvocationResult(new Result(delegate.getTournamentRoundRankingByUserGroup(context, sessionId, betCommunityId, tournRoundId)));
