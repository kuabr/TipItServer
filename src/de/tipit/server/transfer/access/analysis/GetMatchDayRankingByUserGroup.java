...
public class GetMatchDayRankingByUserGroup implements AnalysisTask {
    ...
    public InvocationResult execute(Analysis delegate) {
        try {
            return new InvocationResult(new Result(delegate.getMatchDayRankingByUserGroup(context, sessionId, betCommunityId, matchDayId)));
