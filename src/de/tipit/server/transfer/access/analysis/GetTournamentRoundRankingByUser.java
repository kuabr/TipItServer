...
public class GetTournamentRoundRankingByUser implements AnalysisTask {
    ...
    public InvocationResult execute(Analysis delegate) {
        try {
            return new InvocationResult(
                    new Result(delegate.getTournamentRoundRankingByUser(context, sessionId, betCommunityId, tournRoundId, onlyUsersWithBet)));
