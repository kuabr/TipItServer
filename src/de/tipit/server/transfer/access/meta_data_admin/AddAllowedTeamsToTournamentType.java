...
public class AddAllowedTeamsToTournamentType implements MetaDataAdminTask {
    ...
    public InvocationResult execute(MetaDataAdmin delegate) {
        try {
            return new InvocationResult(new Result(delegate.addAllowedTeamsToTournamentType(context, sessionId, tournTypeId, teamIdList)));
