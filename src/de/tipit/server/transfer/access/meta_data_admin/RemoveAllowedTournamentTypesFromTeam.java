...
public class RemoveAllowedTournamentTypesFromTeam implements MetaDataAdminTask {
    ...
    public InvocationResult execute(MetaDataAdmin delegate) {
        try {
            return new InvocationResult(new Result(delegate.removeAllowedTournamentTypesFromTeam(context, sessionId, teamId, tournTypeIdList)));
