...
public class GetGamesWithPopulatedResultForPeriod implements BetResultTask {
    ...
    public InvocationResult execute(BetResult delegate) {
        try {
            return new InvocationResult(new Result(delegate.getGamesWithPopulatedResultForPeriod(context, sessionId, period)));
