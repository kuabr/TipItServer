...
public class RemoveCommentForGameBet implements BetResultTask {
    ...
    public InvocationResult execute(BetResult delegate) {
        try {
            return new InvocationResult(new Result(delegate.removeCommentForGameBet(context, sessionId, commentId)));
