...
public class GetGamesWithMissingResultForPeriod implements BetResultTask {
    ...
    public InvocationResult execute(BetResult delegate) {
        try {
            return new InvocationResult(new Result(delegate.getGamesWithMissingResultForPeriod(context, sessionId, period)));
