...
public class GetOpenParticipatingTournaments implements BetResultTask {
    ...
    public InvocationResult execute(BetResult delegate) {
        try {
            return new InvocationResult(new Result(delegate.getOpenParticipatingTournaments(context, sessionId)));
