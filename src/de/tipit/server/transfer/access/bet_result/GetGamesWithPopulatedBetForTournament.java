...
public class GetGamesWithPopulatedBetForTournament implements BetResultTask {
    ...
    public InvocationResult execute(BetResult delegate) {
        try {
            return new InvocationResult(new Result(delegate.getGamesWithPopulatedBetForTournament(context, sessionId, tournId)));
