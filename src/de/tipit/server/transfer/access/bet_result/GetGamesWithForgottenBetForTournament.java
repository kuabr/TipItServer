...
public class GetGamesWithForgottenBetForTournament implements BetResultTask {
    ...
    public InvocationResult execute(BetResult delegate) {
        try {
            return new InvocationResult(new Result(delegate.getGamesWithForgottenBetForTournament(context, sessionId, tournId)));
