...
public class RemoveCommentForWinnerBet implements BetResultTask {
    ...
    public InvocationResult execute(BetResult delegate) {
        try {
            return new InvocationResult(new Result(delegate.removeCommentForWinnerBet(context, sessionId, commentId)));
