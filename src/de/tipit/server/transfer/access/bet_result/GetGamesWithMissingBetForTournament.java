...
public class GetGamesWithMissingBetForTournament implements BetResultTask {
    ...
    public InvocationResult execute(BetResult delegate) {
        try {
            return new InvocationResult(new Result(delegate.getGamesWithMissingBetForTournament(context, sessionId, tournId)));
