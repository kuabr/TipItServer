...
public class GetGamesWithMissingTeamsForTournament implements BetResultTask {
    ...
    public InvocationResult execute(BetResult delegate) {
        try {
            return new InvocationResult(new Result(delegate.getGamesWithMissingTeamsForTournament(context, sessionId, tournId)));
